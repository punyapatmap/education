...
course.path = "courses/sharing/srg-2024-2025/"
...
data.frame(Date    = lectures$date, 
           ...
           Presentation  = sprintf('<a href="https://punyapatmap.github.io/education/%s" target="_blank" class="external">link</a>', gsub("qmd", "-speaker.html", lectures$url))
) -> lecture.list
